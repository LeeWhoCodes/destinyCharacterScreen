...
function InventorySlot() {
  ...
  return (
    <div className="border-2 border-yellow-400 bg-purple-600 h-full m-auto overflow-hidden" ref={invRefs.setReference} onMouseEnter={() => invRefs.floating.current.showPopover()} onMouseLeave={() => invRefs.floating.current.hidePopover()}>
